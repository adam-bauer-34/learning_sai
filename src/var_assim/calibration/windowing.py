...
class AssimilationWindowing:
    ...
    @classmethod
    def from_cli_and_yaml(cls, cli_args: argparse.Namespace, windowing_path: Path) -> 'AssimilationWindowing':
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--windowing', type=str, default='original'
    )
    parser.add_argument(
        '--tmin',
        type=int,
    ...
    Windows = AssimilationWindowing.from_cli_and_yaml(args, Path('config/windowing.yaml'))
