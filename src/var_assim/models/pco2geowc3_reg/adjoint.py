...
def get_misfit_t(my_obs, obs, covars, t_ind):
    ...
    mis_TR1TR1 = inv_covar_T_R1[t_ind, t_ind] * misfits[2, t_ind]
    mis_TR2TR2 = inv_covar_T_R2[t_ind, t_ind] * misfits[3, t_ind]
    mis_TR3TR3 = inv_covar_T_R3[t_ind, t_ind] * misfits[4, t_ind]
    ...
    for t in range(len(inv_covar_T1[0, :])):
        ...
        if t != t_ind:
            ...
            tmp_mis_TR1 += inv_covar_T_R1[t_ind, t] * misfits[2, t]
            tmp_mis_TR2 += inv_covar_T_R2[t_ind, t] * misfits[3, t]
            tmp_mis_TR3 += inv_covar_T_R3[t_ind, t] * misfits[4, t]

    # add diagonal and off diagonal pieces and return
    misfit_t[0] = mis_TT + tmp_mis_T
    misfit_t[1] = mis_QQ + tmp_mis_Q
    misfit_t[2] = mis_TR1TR1 + tmp_mis_TR1
    misfit_t[3] = mis_TR2TR2 + tmp_mis_TR2
    misfit_t[4] = mis_TR3TR3 + tmp_mis_TR3
