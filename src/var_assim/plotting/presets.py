    ...
    if markers:
        plotting_presets = {
            ...
            "axes.prop_cycle": plt.cycler(
                linestyle=linestyle_list, color=color_list, marker=marker_list
            ),
            "font.size": 16,
            "font.family": "sans",
        }
        ...
        plotting_presets = {
            ...
            "ytick.major.width": 3,
            "ytick.major.size": 6,
            "axes.prop_cycle": plt.cycler(linestyle=linestyle_list, color=color_list),
            "font.size": 16,
            "font.family": "sans",
        }
