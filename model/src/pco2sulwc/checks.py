...
def get_tlm_check(e, theta, TMIN, TMAX, DT, ALPHA_MIN, ALPHA_MAX,
    ...
    if SAVE_RESULTS:
        # save output to csv
        cwd = os.getcwd()
        datapath = cwd + "/data/checks/pco2sulwc/tlm_check.csv"
...
def get_adj_id_check(e, theta, TMIN, TMAX, DT, SAVE_RESULTS=False):
    ...
    if SAVE_RESULTS:
        # save output to csv
        cwd = os.getcwd()
        datapath = cwd + "/data/checks/pco2sulwc/adj_id_check.csv"
...
def get_cost_grad_check(control, cost_args, ALPHA_MIN, ALPHA_MAX,
    ...
    if SAVE_RESULTS:
        # save output to csv
        cwd = os.getcwd()
        datapath = cwd + "/data/checks/pco2sulwc/cost_grad_check.csv"
