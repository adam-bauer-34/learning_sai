...
def get_nonlin_path(e, theta, TMIN, TMAX, DT):
    ...
    # unpack parameters
    params = theta[:12]
    T10, T20, Q0, L, G, C1, C2, F1_CO2, F3_CO2, A_SO2, B_SO2, C_SO2 = params
    qs = theta[12:]  # model errors
...
def get_TLM_matrix(e, t, nl_path, DT, CHECK_TLM=False):
    ...
    T1, T2, Q, L, G, C1, C2, F1_CO2, F3_CO2, A_SO2, B_SO2, C_SO2 = nl_path[:12, t]
    mod_error = nl_path[12:, t]
    ...
    TLM_matrix[0, 12 + t] = DT / C1  # this bit is for model errors
