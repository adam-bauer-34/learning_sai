...
def get_tlm_check(e, theta, TMIN, TMAX, DT, ALPHA_MIN, ALPHA_MAX,
    ...
    if SAVE_RESULTS:
        # save output to csv
        datapath = DATA_DIR + "/checks/pco2geowc3/tlm_check.csv"
...
def get_adj_id_check(e, theta, TMIN, TMAX, DT, SAVE_RESULTS=False):
    ...
    if SAVE_RESULTS:
        # save output to csv
        datapath = DATA_DIR + "/checks/pco2geowc3/adj_id_check.csv"
...
def get_cost_grad_check(control, cost_args, ALPHA_MIN, ALPHA_MAX,
    ...
    if SAVE_RESULTS:
        # save output to csv
        cwd = os.getcwd()
        datapath = DATA_DIR + "/checks/pco2geowc3/cost_grad_check.csv"
