...
def get_TLM_matrix(e, t, nl_path, DT, CHECK_TLM=False):
    ...
    (T1, T2, Q, TR1, TR2, TR3, L, G, EPS, C1, C2, F1_CO2,
     ALPHA_R1, ALPHA_R2, ALPHA_R3, BETA_R1, BETA_R2, BETA_R3) = nl_path[:18, t]
