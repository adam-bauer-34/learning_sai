...
#SBATCH --job-name=ssp245-ang33
#SBATCH --output=logs/ssp245-ang33.out
#SBATCH --error=logs/ssp245-ang33.err
...
echo "Running base model with angle = 33..."
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 33 3.0 0.1 50 1 2 1

echo "Running high geoengineering scenario with angle = 33..."
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 33 3.0 0.2 50 1 2 1

echo "Running AR(0) model with angle = 33..."
python -m model.main_margobs_pco2geowc_ws ssp245 2025 0 33 3.0 0.2 50 1 2 1

echo "Running no noise version with angle = 33..."
python -m model.main_margobs_pco2geowc-nn_ws_nonoise ssp245 2025 33 3.0 0.1 50 1 2 1 

echo "Running three region model with angle = 33..."
python -m model.main_margobs_pco2geowc3_ws ssp245 2025 1 33 3.0 0.1 50 1 2 1 
