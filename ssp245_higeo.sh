...
#SBATCH --job-name=ssp245-higeo
#SBATCH --output=logs/ssp245-higeo.out
#SBATCH --error=logs/ssp245-higeo.err
...
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 9 3.0 0.2 50 1 500 1 
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 12 3.0 0.2 50 1 500 1 
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 14 3.0 0.2 50 1 500 1 
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 17 3.0 0.2 50 1 500 1 
python -m model.main_margobs_pco2geowc_ws ssp245 2025 1 21 3.0 0.2 50 1 500 1 
